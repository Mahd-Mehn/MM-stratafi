...
export default function Portfolio() {
  ...
  const fetchPortfolioData = async () => {
    setLoading(true)
    // Simulate fetching user's investments
    setTimeout(() => {
      const mockInvestments: Investment[] = [
        {
          poolId: 1,
          poolName: 'Invoice Financing Pool #1',
          tranche: 'Senior',
          amount: 50000,
        ...
        {
          poolId: 2,
          poolName: 'Real Estate Bridge Loans #3',
          tranche: 'Mezzanine',
          amount: 30000,
        ...
        {
          poolId: 5,
          poolName: 'Trade Finance Facility #2',
          tranche: 'Senior',
          amount: 25000,
        ...
        {
          poolId: 3,
          poolName: 'Supply Chain Finance Pool',
          tranche: 'Junior',
          amount: 15000,
      ...
      const avgAPY = mockInvestments.reduce((sum, inv) => sum + inv.apy, 0) / mockInvestments.length
      const avgHealthScore = mockInvestments.reduce((sum, inv) => sum + inv.healthScore, 0) / mockInvestments.length
      ...
      setStats({
        ...
        totalReturns,
        avgAPY,
        activePositions: mockInvestments.length,
        riskScore: avgHealthScore
      })
                ...
                {investments.map((investment, index) => (
                  ...
                  >
                    <td className="py-4 px-4">
                      ...
                      <p className="text-gray-500 text-xs">ID: {investment.poolId}</p>
                    </td>
                    <td className="py-4 px-4">
                    ...
                    <td className="py-4 px-4 text-right">
                      ...
                      <p className="text-gray-500 text-xs">
                        {Math.ceil((new Date(investment.maturityDate).getTime() - Date.now()) / (1000 * 60 * 60 * 24))} days
                      </p>
                    </td>
